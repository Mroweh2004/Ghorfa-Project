        ...
        <aside class="admin-sidebar" id="adminSidebar">
            <div class="sidebar-header">
                <div class="sidebar-logo">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo" width="32px">
            ...
            <nav class="sidebar-nav">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item">
                            <a href="#applications-section" class="nav-link">
                                ...
                                <?php if(isset($stats) && $stats['pending_applications'] > 0): ?>
                                    <span class="nav-badge"><?php echo e($stats['pending_applications']); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('search')); ?>" class="nav-link" target="_blank">
                ...
                <div class="header-right">
                    ...
                    <div class="user-dropdown">
                        <button class="user-profile-btn" id="userProfileBtn">
                            <img src="<?php echo e(auth()->user()->profile_image ? asset('storage/' . auth()->user()->profile_image) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&background=3b82f6&color=fff'); ?>" alt="<?php echo e(auth()->user()->name); ?>">
...
<?php /**PATH C:\Ghorfa-Project\resources\views/layouts/admin.blade.php ENDPATH**/ ?>