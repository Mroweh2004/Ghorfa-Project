        ...
        <section id="Main-Container" class="Main-Container">
            <div class="Main-Container-content">
                ...
                <div class="search-container">
                    <form class="search-box" action="<?php echo e(route('filter-search')); ?>" method="GET">
                    ...
                    <div class="popular-searches">
                        <span>Popular:</span>
                        <a href="<?php echo e(route('filter-search', ['location' => 'Beirut'])); ?>">Beirut</a>
                        <a href="<?php echo e(route('filter-search', ['location' => 'Saida'])); ?>">Saida</a>
                        <a href="<?php echo e(route('filter-search', ['location' => 'Tyre'])); ?>">Tyre</a>
                        <a href="<?php echo e(route('filter-search', ['location' => 'Baalbak'])); ?>">Baalbak</a>
                    </div>
                </div>
            </div>
        </section>
    ...
    <main>
        ...
        <section id="additional-section" class="additional-section">
            <div class="additional-section-content">
                ...
                <div class="additional-section-buttons">
                    <button onclick="location.href='<?php echo e(route('register')); ?>'" class="main-list-btn">
                        <i class="fas fa-user-plus"></i> Register Now
                    </button>
                    <button onclick="location.href='<?php echo e(route('login')); ?>'" class="secondary-list-btn">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Ghorfa-Project\resources\views/home.blade.php ENDPATH**/ ?>